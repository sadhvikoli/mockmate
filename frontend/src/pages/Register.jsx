    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{background: 'linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 50%, #ecfdf5 100%)'}}>
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-xl" style={{border: '2px solid #e0f2fe'}}>
          <h2 className="text-2xl font-black mb-6" style={{fontFamily: 'Nunito', color: '#0c4a6e'}}>Create account ✨</h2>
          {error && (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="text-sm font-bold block mb-2" style={{color: '#64748b'}}>Username</label>
              <input
                type="text"
                value={username}
          ...
          <p className="text-sm text-center mt-4 font-semibold" style={{color: '#64748b'}}>
            ...
            <Link to="/login" className="font-black" style={{color: '#0ea5e9'}}>Sign in</Link>
          </p>
        </div>
      </div>
    </div>
